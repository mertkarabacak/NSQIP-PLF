...
data = load_dataset("mertkarabacak/NSQIP-PLF", data_files="plf_imputed.csv", use_auth_token = HF_TOKEN)
...
y1_xgb_params = {'objective': 'binary:logistic', 'booster': 'gbtree', 'lambda': 0.0005339267129552805, 'alpha': 0.0002962624636897887, 'max_depth': 5, 'eta': 0.17974463946440886, 'gamma': 1.955720731101234e-05, 'grow_policy': 'depthwise'}
y2_xgb_params = {'objective': 'binary:logistic', 'booster': 'gbtree', 'lambda': 2.3651795227170203e-07, 'alpha': 2.465112299158626e-07, 'max_depth': 8, 'eta': 0.2016812333750978, 'gamma': 1.9072531571694956e-08, 'grow_policy': 'lossguide'}
y3_xgb_params = {'objective': 'binary:logistic', 'booster': 'gbtree', 'lambda': 3.9182180074030555e-05, 'alpha': 3.7622090080846917e-06, 'max_depth': 9, 'eta': 0.34884518185962, 'gamma': 0.003045967534081103, 'grow_policy': 'depthwise'}

y1_lgb_params = {'objective': 'binary', 'boosting_type': 'gbdt', 'lambda_l1': 0.007709569546582118, 'lambda_l2': 0.3386728384875079, 'num_leaves': 187, 'feature_fraction': 0.6292732071397759, 'bagging_fraction': 0.9756997529130697, 'bagging_freq': 4, 'min_child_samples': 10}
y2_lgb_params = {'objective': 'binary', 'boosting_type': 'gbdt', 'lambda_l1': 1.3688333191815587e-06, 'lambda_l2': 0.052511051903638244, 'num_leaves': 205, 'feature_fraction': 0.5865629820653324, 'bagging_fraction': 0.9571048929526229, 'bagging_freq': 4, 'min_child_samples': 5}
y3_lgb_params = {'objective': 'binary', 'boosting_type': 'gbdt', 'lambda_l1': 2.1265290416768583e-05, 'lambda_l2': 0.0018014878119387177, 'num_leaves': 192, 'feature_fraction': 0.8493327170839868, 'bagging_fraction': 0.8945035345315162, 'bagging_freq': 5, 'min_child_samples': 6}

y1_cb_params = {'objective': 'Logloss', 'colsample_bylevel': 0.06756293020840613, 'depth': 12, 'boosting_type': 'Plain', 'bootstrap_type': 'Bernoulli', 'subsample': 0.2396438345614389}
y2_cb_params = {'objective': 'CrossEntropy', 'colsample_bylevel': 0.0973566655789677, 'depth': 10, 'boosting_type': 'Ordered', 'bootstrap_type': 'MVS'}
y3_cb_params = {'objective': 'Logloss', 'colsample_bylevel': 0.08817565012542608, 'depth': 11, 'boosting_type': 'Plain', 'bootstrap_type': 'MVS'}

y1_rf_params = {'criterion': 'entropy', 'max_features': 'log2', 'max_depth': 75, 'n_estimators': 1800, 'min_samples_leaf': 1, 'min_samples_split': 10}
y2_rf_params = {'criterion': 'gini', 'max_features': 'log2', 'max_depth': 88, 'n_estimators': 1900, 'min_samples_leaf': 1, 'min_samples_split': 9}
y3_rf_params = {'criterion': 'entropy', 'max_features': 'log2', 'max_depth': 78, 'n_estimators': 1500, 'min_samples_leaf': 4, 'min_samples_split': 6}
...
with gr.Blocks(title="NSQIP-PLF") as demo:
    ...
    gr.Markdown(
        """
    # Prediction Tool
    ## Short-Term Postoperative Outcomes Following Posterior Lumbar Fusion
    **The publication describing the details of this predictive tool will be posted here upon the acceptance of publication.**
    ...
    with gr.Tab('Length of Stay'):
        ...
        ### Prolonged Length of Stay Prediction Model for Posterior Lumbar Fusion
        """
        )
    ...
    with gr.Tab('Non-home Discharge'):
        ...
        ### Non-home Discharge Prediction Model for Posterior Lumbar Fusion
        """
        )
    ...
    with gr.Tab('Readmission'):
        ...
        ### Readmission Prediction Model for Posterior Lumbar Fusion        
        """
        )
